...
return [
    ...
    'Can manage users' => 'Peut gérer les utilisateurs',
    'Can manage bookings' => 'Peut gérer les réservations',
    'Can manage events' => 'Peut gérer les événements',
    'Can manage tournaments' => 'Peut gérer les tournois',
    'Can change configuration' => 'Peut changer la configuration',
    'Sees the admin menu' => 'Peut voir le menu admin',
    'Sees past bookings' => 'Peut voir le passé dans calendrier',
    'Sees names and data in calendar' => 'Peut voir les nom et données dans le calendrier',
    'Can create single bookings' => 'Peut créer des réservations simple',
    'Can cancel single bookings' => 'Peut annuler des réservations simple',
    'Can delete single bookings' => 'Peut supprimer des réservations simple',
    'Can create recurring bookings' => 'Peut créer des réservations multiples',
    'Can cancel recurring bookings' => 'Peut annuler des réservations multiples',
    'Can delete recurring bookings' => 'Peut supprimer des réservations multiples',
